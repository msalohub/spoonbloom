...
export default function Shop() {
  ...
  return (
    <>
        <Head>
        <title>drawings | spoonbloom ᯓ★ </title>
        <meta name="description" content="Shop for SpoonBloom's unique creations" />
        </Head>
        ...
        <div className="main-content" id="shirts">
          <div className="section-header">
            ...
            <h2 className="clay-title">Gallery</h2>
            <div className="gif-container">
              <Image 
                src="https://i.pinimg.com/originals/05/bf/b1/05bfb13dbad7c8f3815c723d4c0c34be.gif" 
                alt="Right Cute GIF" 
          ...
          <p className="blurb">A silly little gallery of some digital art, made with love and freak &lt;3</p>
        ...
        <div className="main-content" id="shirts">
          ...
          <h2 className="clay-title">Collages</h2>
          <div className="gif-container">
            <Image 
              src="https://i.pinimg.com/originals/05/bf/b1/05bfb13dbad7c8f3815c723d4c0c34be.gif" 
              alt="Right Cute GIF" 
        ...
        <p className="blurb">Signature super flavorful and fun and colorful personalized collages XD</p>
